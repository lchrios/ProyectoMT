...
public class Persona {
		double impuesto, porcentajeExcedente, aguinaldoExcento, aguinaldoGravado,sueldoAnual, primaExcenta, primaGravada, totalIngresos, coutaFija, limInf;
		...
		public void Calcula(String[] datos, double deduccion) {
			double a = Double.parseDouble(datos[2]);
			double sueldo = a;
			a = Double.parseDouble(datos[3]);
			double aguinaldo = a;
			...
			this.totalIngresos = sueldoAnual + aguinaldoGravado + primaGravada;
			double impuestos = 0;
